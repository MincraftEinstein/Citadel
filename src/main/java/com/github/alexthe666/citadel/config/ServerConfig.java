...
public class ServerConfig {
    ...
    public final Supplier<Boolean> citadelEntityTracker = () -> true;
    public final Supplier<Boolean> skipDatapackWarnings = () -> true;
    public final Supplier<Double> chunkGenSpawnModifier = () -> 1D;
    public final Supplier<Boolean> aprilFoolsContent = () -> true;
